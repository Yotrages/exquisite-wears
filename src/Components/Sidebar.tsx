  ...
  return (
    ...
    >
      <div
        ...
        className="flex cursor-pointer items-end justify-end px-3"
      >
        <IoMdClose className="text-black size-10 hover:scale-105" />
      </div>
      <ul className="flex flex-col gap-3 px-3">
        <Link
          className="text-lg font-semibold hover:text-gray-500 active:text-green-600 transition-all duration-300 hover:ml-2 "
          to="/"
        >
          Home
        </Link>
